const { proto, DEFAULT_CONNECTION_CONFIG, toNumber, updateMessageWithReceipt, jidNormalizedUser } = require("baileys")
const make_ordered_dictionary_1 = require("baileys/lib/Store/make-ordered-dictionary")
const waChatKey = (pin) => ({
